...
class NoKPrjMgntModelTaskComment extends JModelForm {
	/**
	 * @since   1.6
	 */
	private $pk = '0';
	private $useAlias= true;
	protected $view_item = 'TaskComment';
	protected $_item = null;
	protected $_membershipItems = null;
	protected $_model = 'taskcomment';
	protected $_component = 'com_nokprjmgnt';
	protected $_context = 'com_nokprjmgnt.taskcomment';
	protected $_commentItems = null;

	private function getFields() {
		return array (
			"id" => array(JText::_('COM_NOKPRJMGNT_COMMON_FIELD_ID_LABEL',true),'`c`.`id`'),
			"project_id" => array(JText::_('COM_NOKPRJMGNT_COMMENT_FIELD_PROJECT_ID_LABEL',true),'`t`.`project_id`'),
			"project" => array(JText::_('COM_NOKPRJMGNT_COMMENT_FIELD_PROJECT_LABEL',true),'`p`.`title`'),
			"task_id" => array(JText::_('COM_NOKPRJMGNT_COMMENT_FIELD_PROJECT_ID_LABEL',true),'`c`.`task_id`'),
			"task" => array(JText::_('COM_NOKPRJMGNT_COMMENT_FIELD_PROJECT_LABEL',true),'`t`.`title`'),
			"title" => array(JText::_('COM_NOKPRJMGNT_COMMENT_FIELD_TITLE_LABEL',true),'`c`.`title`'),
	 ...
	 */
	public function getTable($type = 'TAskComment', $prefix = 'NoKPrjMgntTable', $config = array()) {
