...
class NoKPrjMgntModelTaskComment extends JModelAdmin {
	...
	public function getForm($data = array(), $loadData = true) {
		// Get the form.
		$form = $this->loadForm($this->typeAlias, 'taskcomment', array('control' => 'jform', 'load_data' => $loadData));
	...
	protected function loadFormData() {
		...
		$data = $app->getUserState('com_nokprjmgnt.edit.taskcomment.data', array());
		if (empty($data)) {
			$data = $this->getItem();
		}
		$this->preprocessData('com_nokprjmgnt.taskcomment', $data);
		return $data;
	}
