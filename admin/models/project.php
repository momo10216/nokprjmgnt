...
class NoKPrjMgntModelProject extends JModelAdmin {
	protected $text_prefix = 'com_nokprjmgnt';
	public $typeAlias = 'com_nokprjmgnt.project';
	...
	public function getForm($data = array(), $loadData = true) {
		// Get the form.
		$form = $this->loadForm($this->typeAlias, 'project', array('control' => 'jform', 'load_data' => $loadData));
	...
	protected function loadFormData() {
		...
		$data = $app->getUserState('com_nokprjmgnt.edit.project.data', array());
		if (empty($data)) {
			$data = $this->getItem();
		}
