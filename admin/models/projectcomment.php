...
class NoKPrjMgntModelProjectComment extends JModelAdmin {
	...
	public $typeAlias = 'com_nokprjmgnt.projectcomment';
	...
	public function getForm($data = array(), $loadData = true) {
		// Get the form.
		$form = $this->loadForm($this->typeAlias, 'projectcomment', array('control' => 'jform', 'load_data' => $loadData));
	...
	protected function loadFormData() {
		...
		$data = $app->getUserState('com_nokprjmgnt.edit.projectcomment.data', array());
		if (empty($data)) {
			$data = $this->getItem();
		}
		$this->preprocessData('com_nokprjmgnt.projectcomment', $data);
		return $data;
	}
