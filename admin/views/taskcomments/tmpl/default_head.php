...
<tr>
	...
	<th>
		<?php echo JHtml::_('grid.sort', 'COM_NOKPRJMGNT_COMMENT_FIELD_TASK_LABEL', 't.title', $listDirn, $listOrder); ?>
	</th>
	<th>
	...
	<th>
		<?php echo JHtml::_('grid.sort', 'COM_NOKPRJMGNT_COMMON_FIELD_CREATEDBY_LABEL', 'c.createdby', $listDirn, $listOrder); ?>
	</th>
</tr>
